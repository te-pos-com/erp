...
class Subscriptions_model extends CI_Model
{
    ...
    public function invoice_details($id)
    {
        ...
        $this->db->select('te_invoices.*,te_invoices.id AS iid,te_customers.*,te_customers.id AS cid,te_terms.id AS termid,te_terms.title AS termtit,te_terms.terms AS terms');
