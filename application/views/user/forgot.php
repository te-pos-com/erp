...
<div class="d-lg-flex half">
    <div class="bg order-1 order-md-2" style="background-image: url('<?= base_url();?>assets/images/bg_2.JPG');"></div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    ...
                    <form action="#" id="frmlogin" name="frmlogin" method="post">
                        ...
                        <input type="email" class="form-control" placeholder="<?php echo $this->lang->line('Your Email') ?>" name="email" id="user-email">
                        <input type="hidden" id="action-url" value="user/send_reset">
                      
                        </div>
                        <button id="submit-data" class="btn btn-block btn-primary">
                            <i
                            class="icon-lock4"
